...
namespace OpenRpg.Combat.Extensions
{
    public static class CombatExtensions
    {
        ...
        public static float CalculateTotal(this IReadOnlyCollection<Effect> effects, int effectAmountType, int effectPercentageType, int bonusAmountType, int bonusPercentageType)
        {
