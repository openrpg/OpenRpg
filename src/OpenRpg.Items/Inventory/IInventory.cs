...
namespace OpenRpg.Items.Inventory
{
    ...
    public interface IInventory
    {
        ...
        /// </summary>
        /// <param name="itemInstance">The item you want to add</param>
