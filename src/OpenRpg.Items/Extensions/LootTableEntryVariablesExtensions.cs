...
namespace OpenRpg.Items.Extensions
{
    ...
    {
        public static float DropRate(this ILootTableEntryVariables variables) => Convert.ToSingle(variables.GetVariable(LootTableEntryVariableTypes.DropRate));
        ...
        public static bool IsUnique(this ILootTableEntryVariables variables) => Convert.ToBoolean(variables.GetVariable(LootTableEntryVariableTypes.IsUnique));
