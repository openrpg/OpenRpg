...
namespace OpenRpg.Items.Extensions
{
    public static class ItemTemplateVariablesExtensions
    {
        ...
        public static int Weight(this IItemTemplateVariables variables) => (int)variables[ItemTemplateVariableTypes.Weight];
        public static void Weight(this IItemTemplateVariables variables, int value) => variables[ItemTemplateVariableTypes.Weight] = value;
