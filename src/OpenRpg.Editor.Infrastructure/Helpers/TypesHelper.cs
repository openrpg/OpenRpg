...
namespace OpenRpg.Editor.Infrastructure.Helpers
{
    public static class TypesHelper
    {
        ...
        public static readonly OptionData[] GetCraftingSkillTypes = GetTypesFor(typeof(FantasyTradeSkillTypes)).OrderBy(x => x.Id).ToArray();
        public static readonly OptionData[] GetGatheringSkillTypes = GetTypesFor(typeof(FantasyTradeSkillTypes)).OrderBy(x => x.Id).ToArray();
    }
}