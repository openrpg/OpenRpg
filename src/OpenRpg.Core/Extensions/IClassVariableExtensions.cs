...
namespace OpenRpg.Core.Extensions
{
    ...
    {
        public static int Level(this IClassVariables vars) => Convert.ToInt32(vars.Get(ClassVariableTypes.Level) ?? 1) ;
        public static void Level(this IClassVariables vars, int level) => vars[ClassVariableTypes.Level] = level;
        
        public static int Experience(this IClassVariables vars) => Convert.ToInt32(vars.Get(ClassVariableTypes.Experience) ?? 0);
